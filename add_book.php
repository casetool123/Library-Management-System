...
<div class="row">
        ...
        <center><h3> Add New Book</h3></center>
			...
			<div class="form-group">
				...
				<button class="btn btn-info" name="add_book">Add Book</button>
...
<?php
	if(isset($_POST['add_book'])){
		...
		$query = "INSERT into books values($_POST[book_id],'$_POST[book_title]',$_POST[publisher_id],$_POST[category_id],$_POST[book_price])";
